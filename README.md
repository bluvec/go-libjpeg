...
[![GoDoc](https://godoc.org/github.com/bluvec/go-libjpeg/jpeg?status.svg)](https://godoc.org/github.com/bluvec/go-libjpeg/jpeg)
[![Build Status](https://travis-ci.org/bluvec/go-libjpeg.svg?branch=master)](https://travis-ci.org/bluvec/go-libjpeg)

An implementation of Go binding for LibJpeg (preferably libjpeg-turbo).

The core codes are picked from [go-thumber](http://github.com/bluvec/go-thumber)
and rewritten to compatible with image.Image interface.

## Usage

```
import "github.com/bluvec/go-libjpeg/jpeg"
...
Copyright (c) 2014 bluvec Inc. All rights reserved.
